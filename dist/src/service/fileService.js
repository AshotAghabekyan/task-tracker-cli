...
var FileService = /** @class */ (function () {
    function FileService(dirPath, fileName) {
    ...
    FileService.prototype.writeFile = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.promises.writeFile(this.filePath, JSON.stringify(data, null, 2), "utf-8")];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
